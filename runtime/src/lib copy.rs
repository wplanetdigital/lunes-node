...
fn get_fee_distribution(amount: Balance) -> (Perbill, Perbill, Perbill) {

	if amount < 10 {
		(Perbill::from_percent(12.5), Perbill::from_percent(12.5), Perbill::from_percent(75)) 
	} else if amount < 100 {
		(Perbill::from_percent(12.5), Perbill::from_percent(12.5), Perbill::from_percent(75))
	} else if amount < 1000 {
		(Perbill::from_percent(12.5), Perbill::from_percent(12.5), Perbill::from_percent(75))
	} else if amount < 10000 {
		(Perbill::from_percent(25), Perbill::from_percent(25), Perbill::from_percent(50))
	} else if amount < 100000 {
		(Perbill::from_percent(25), Perbill::from_percent(25), Perbill::from_percent(50))
	} else if amount < 1000000 {
		(Perbill::from_percent(30), Perbill::from_percent(30), Perbill::from_percent(40))
	} else {
		(Perbill::from_percent(30), Perbill::from_percent(30), Perbill::from_percent(40))
	}  
}
...
impl pallet_transaction_payment::Config for Runtime {
	...
	type OnTransactionPayment = OnTransactionPayment;
}

struct OnTransactionPayment;

impl OnTransactionPayment {

	fn on_transaction_payment(fee_amount: Balance) {
	  
	  let (node_cut, lunes_cut, burn_cut) = get_fee_distribution(fee_amount);
		
	  let node_fee = node_cut * fee_amount;
	  let lunes_fee = lunes_cut * fee_amount;
	  let burn_fee = fee_amount - node_fee - lunes_fee;
	  
	  Balances::transfer(node_account, node_fee);
	  Balances::transfer(lunes_account, lunes_fee);
	  Balances::burn(burn_fee);
...
impl_runtime_apis! {
	impl sp_api::Core<Block> for Runtime {
		...
		fn initialize_block(header: &<Block as BlockT>::Header) {
			let fee = TransactionPayment::compute_fees();  
			OnTransactionPayment::on_transaction_payment(fee);
		}
	}
